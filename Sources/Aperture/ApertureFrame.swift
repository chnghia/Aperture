...
public final class ApertureFrame: NSObject {
  ...
  public var onCapture: ((AVCaptureOutput, CMSampleBuffer) -> Void)?
	...
	Use `ApertureFrame.Devices.screen()` to get a list of available screens.
...
// extension ApertureFrame: AVCaptureFileOutputRecordingDelegate {
